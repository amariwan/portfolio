...
export const Mailchimp = ({ newsletter }: { newsletter: NewsletterProps }) => {
	...
	return (
		<Column overflow='hidden' position='relative' fillWidth padding='xl' radius='l' marginBottom='m' horizontal='center' align='center' background='surface' border='neutral-medium'>
			<Background
				mask={{
				...
				grid={{
					...
					// height property removed as it is not present in the type
